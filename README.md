...
conceptual and techinacal prototype is a funtional sketch.

# Descriprion
This project is a conceptual and technical prototype for my Mouspike brand this web prototype represent an early functinal "sketch" created before building the official Shopify website.
The page is not the final or official website it was created as a first step to visually and technically explore how the brand should look, feel, and how communicate before launching the full platform.
The goal of this project was not just to sell products yet,  but it was to validate ideas and turn an abstract vision into something real and structured with the right vision.
